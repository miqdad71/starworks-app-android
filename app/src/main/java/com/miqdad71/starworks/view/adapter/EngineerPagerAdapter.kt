...
import com.miqdad71.starworks.view.fragments.engineer.EngineerExperienceFragment
import com.miqdad71.starworks.view.fragments.engineer.EngineerPortofolioFragment
...
class EngineerPagerAdapter(fragmentManager: FragmentManager): FragmentStatePagerAdapter(fragmentManager, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT) {
    ...
    private val fragment = arrayOf(EngineerPortofolioFragment(), EngineerExperienceFragment())
