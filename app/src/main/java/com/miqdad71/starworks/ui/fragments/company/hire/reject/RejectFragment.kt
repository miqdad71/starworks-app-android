...
import com.miqdad71.starworks.databinding.FragmentRejectBinding
...
import com.miqdad71.starworks.ui.fragments.company.hire.reject.adapter.RejectHireAdapter
...
class RejectFragment : BaseFragmentCoroutine<FragmentRejectBinding>(), RejectContract.View {
    ...
    override fun onResultSuccess(list: List<HireModel>) {
        (binding.rvHire.adapter as RejectHireAdapter).addList(list)
