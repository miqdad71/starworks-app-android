...
import com.miqdad71.starworks.databinding.FragmentApproveBinding
...
import com.miqdad71.starworks.ui.fragments.company.hire.approve.adapter.ApproveHireAdapter
...
class ApproveFragment : BaseFragmentCoroutine<FragmentApproveBinding>(), ApproveContract.View {
    ...
    override fun onResultSuccess(list: List<HireModel>) {
        (binding.rvHire.adapter as ApproveHireAdapter).addList(list)
